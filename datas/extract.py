...
def extract_features(
    ...
    model, val_transform, patch_size, num_heads = utils.get_model(model_name,"vit_small")
...
def extract_bbox_features(
    ...
    model, val_transform, patch_size, num_heads = utils.get_model(model_name_lower,'vit_small',8,1)
    model.eval().to('cuda')
